...
(function () {
  ...
  function runDashboardReveal() {
    // El head agrega .nexus-dashboard-reveal-pending en cada carga/recarga (salvo el
    // deep-link de venta). La entrada es una @keyframes CSS que se dispara SOLA apenas
    // cada tarjeta se crea con esa clase puesta (incluidas las del Inicio que se pintan
    // unos ms después) → no hay carrera de timing y SIEMPRE se ve. Acá solo limpiamos
    // la clase cuando la animación ya terminó (suelta el will-change y el overflow).
    ...
    // Delays ≤ ~545ms + duración 660ms ≈ 1.2s; margen para un repintado tardío.
    window.setTimeout(() => {
  ...
  const elements = {
    ...
    shopeeConnectPanel: document.getElementById("shopeeConnectPanel"),
    shopeeConnectStatus: document.getElementById("shopeeConnectStatus"),
    shopeeConnectButton: document.getElementById("shopeeConnectButton"),
    shopeeMessage: document.getElementById("shopeeMessage"),
    ...
    commerceCostsPanel: document.getElementById("commerceCostsPanel"),
    commerceCostsRevenue: document.getElementById("commerceCostsRevenue"),
    commerceCostsUnits: document.getElementById("commerceCostsUnits"),
    commerceCostsCharges: document.getElementById("commerceCostsCharges"),
    commerceCostsChargesPct: document.getElementById("commerceCostsChargesPct"),
    commerceCostsReceived: document.getElementById("commerceCostsReceived"),
    ...
    // Vista de detalle de venta (estilo Mercado Libre)
    ventaLista: document.getElementById("ventaLista"),
    ventaDetail: document.getElementById("ventaDetail"),
    ventaBack: document.getElementById("ventaBack"),
    ventaTitulo: document.getElementById("ventaTitulo"),
    ventaId: document.getElementById("ventaId"),
    ventaFecha: document.getElementById("ventaFecha"),
    ventaFoto: document.getElementById("ventaFoto"),
    ...
    ventaCargos: document.getElementById("ventaCargos"),
    ventaEnvio: document.getElementById("ventaEnvio"),
    ventaTotal: document.getElementById("ventaTotal"),
    ventaLiberacion: document.getElementById("ventaLiberacion"),
    ventaComprador: document.getElementById("ventaComprador"),
    ventaEnvioBloque: document.getElementById("ventaEnvioBloque"),
    ...
    adsDetail: document.getElementById("adsDetail"),
    adsBack: document.getElementById("adsBack"),
    adsDetailName: document.getElementById("adsDetailName"),
    adsDetailStatus: document.getElementById("adsDetailStatus"),
    adsToggleBtn: document.getElementById("adsToggleBtn"),
    adsNameInput: document.getElementById("adsNameInput"),
    adsBudgetInput: document.getElementById("adsBudgetInput"),
    adsRoasInput: document.getElementById("adsRoasInput"),
    ...
    adsCreateForm: document.getElementById("adsCreateForm"),
    adsNewName: document.getElementById("adsNewName"),
    adsNewBudget: document.getElementById("adsNewBudget"),
    adsNewRoas: document.getElementById("adsNewRoas"),
    adsCreateBtn: document.getElementById("adsCreateBtn"),
    adsCreateCancel: document.getElementById("adsCreateCancel"),
    adsCreateMsg: document.getElementById("adsCreateMsg"),
    adsAddInput: document.getElementById("adsAddInput"),
    adsAddBtn: document.getElementById("adsAddBtn"),
    adsItemList: document.getElementById("adsItemList"),
    adsDetailMsg: document.getElementById("adsDetailMsg"),
    ...
    invResync: document.getElementById("invResync"),
    invListingBody: document.getElementById("invListingBody"),
    invListingEmpty: document.getElementById("invListingEmpty"),
    invCompose: document.getElementById("invCompose"),
    invComposeTitle: document.getElementById("invComposeTitle"),
    invComposeRows: document.getElementById("invComposeRows"),
    invComposeAdd: document.getElementById("invComposeAdd"),
    invComposeSave: document.getElementById("invComposeSave"),
    invComposeCancel: document.getElementById("invComposeCancel"),
    invComposeMsg: document.getElementById("invComposeMsg"),
    invLog: document.getElementById("invLog"),
    // Tienda web propia (Alpha Fitness) — enlace de stock central
    invStoreBody: document.getElementById("invStoreBody"),
    invStoreEmpty: document.getElementById("invStoreEmpty"),
    invStoreReload: document.getElementById("invStoreReload"),
    invStoreSync: document.getElementById("invStoreSync"),
    invStoreCompose: document.getElementById("invStoreCompose"),
    invStoreComposeTitle: document.getElementById("invStoreComposeTitle"),
    invStoreComposeRows: document.getElementById("invStoreComposeRows"),
    invStoreComposeSave: document.getElementById("invStoreComposeSave"),
    invStoreComposeCancel: document.getElementById("invStoreComposeCancel"),
    invStoreComposeMsg: document.getElementById("invStoreComposeMsg"),
