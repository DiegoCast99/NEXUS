...
(function () {
  ...
  const elements = {
    ...
    mpAccountName: document.getElementById("mpAccountName"),
    mpStats: document.getElementById("mpStats"),
    mpBalance: document.getElementById("mpBalance"),
    mpNote: document.getElementById("mpNote"),
    mpNextBody: document.getElementById("mpNextBody"),
    mpTableBody: document.getElementById("mpTableBody"),
    mpEmpty: document.getElementById("mpEmpty"),
    mpConnect: document.getElementById("mpConnect"),
    mpConnectState: document.getElementById("mpConnectState"),
    mpConnectMsg: document.getElementById("mpConnectMsg"),
    mpToken: document.getElementById("mpToken"),
    mpSaveToken: document.getElementById("mpSaveToken"),
    mpHeroBalance: document.getElementById("mpHeroBalance"),
    mpHeroGrowth: document.getElementById("mpHeroGrowth"),
    mpReleaseToggle: document.getElementById("mpReleaseToggle"),
    mpReleaseAmount: document.getElementById("mpReleaseAmount"),
    mpActivityList: document.getElementById("mpActivityList"),
    mpDetail: document.getElementById("mpDetail"),
